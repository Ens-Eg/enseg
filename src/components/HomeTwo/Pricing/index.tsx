    ...
    <div className="pricing-area pt-100 pb-70">
      <div className="container">
        <div className="section-title">
          <span>جديد العروض</span>
          <h2>عروض خاصة مميزة</h2>
          <p>
          نقدم عروضًا خاصة لاستضافة وتصميم المواقع الشخصية والشركات، تشمل مجموعة من المزايا الفريدة , استفد من عروضنا الخاصة اليوم وانطلق بموقعك الشخصي أو شركتك نحو النجاح!
          </p>
        </div>
